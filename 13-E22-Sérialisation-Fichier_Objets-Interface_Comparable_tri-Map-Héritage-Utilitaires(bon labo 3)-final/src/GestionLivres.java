...
public class GestionLivres {
	...
	public static void afficherEntete() {
		...
		sortieBrut.append("NUMÉRO\tTITRE\t\tPAGES\tCATÉGORIE\n");
	}
	...
	public static void listerLivresMapTrie() {
		...
		for(Integer cle : listeClesTriees){
			sortieBrut.append(biblioMap.get(cle).toString());
		}

		sortieBrut.append("Nombre de livres = " + biblioMap.size());
		JOptionPane.showMessageDialog(null, sortieBrut, null, JOptionPane.PLAIN_MESSAGE);
	}
	...
	public static void ajouterUnLivreList() {
		...
		int categorie = Integer
				.parseInt(JOptionPane.showInputDialog(null, "Entrez la catégorie", "AJOUTER UN LIVRE",
						JOptionPane.PLAIN_MESSAGE));
		listeLivres.add(new Livre(num, titre, pages, categorie));
	}
