...
public class GestionsVols {
	...
	public static void insererVol() {
		int numVol = Integer.parseInt(JOptionPane.showInputDialog(null, "Entrez le num�ro du vol", "Saisie du num�ro de vol", JOptionPane.PLAIN_MESSAGE));
		tabVols.forEach((vol ->{
		...
		int jour = Integer
				.parseInt(JOptionPane.showInputDialog(null, "Entrez le num�ro du vol", "Saisie du jour de depart", JOptionPane.PLAIN_MESSAGE));
		int mois = Integer
				.parseInt(JOptionPane.showInputDialog(null, "Entrez le num�ro du vol", "Saisie du mois de depart", JOptionPane.PLAIN_MESSAGE));
		int annee = Integer
				.parseInt(JOptionPane.showInputDialog(null, "Entrez le num�ro du vol", "Saisie de l'ann�e de depart", JOptionPane.PLAIN_MESSAGE));
